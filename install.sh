...
sed -i 's/password_here/Dlckdgns123!/g' /var/www/html/wp-config.php
sed -i 's/localhost/test.cc7o134xa0yc.ap-northeast-2.rds.amazonaws.com/g' /var/www/html/wp-config.php
